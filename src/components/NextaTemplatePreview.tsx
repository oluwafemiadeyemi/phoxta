...
import { injectContentIntoNexta } from '@/lib/nextaTemplateEngine'

const TEMPLATE_BASE_URL = '/templates/nexta/'

/**
 * Renders the Nexta HTML template inside an iframe with AI-generated content
 * injected into all sections. Supports inline text editing via postMessage.
 */
export function NextaTemplatePreview(props: TemplateProps) {
  const {
    landingData,
    setLandingData,
    generatedImages,
    ...
    const handleMessage = (event: MessageEvent) => {
      ...
      if (event.data.type === 'phoxta-edit') {
        ...
        const keyMap: Record<string, string> = {
          ...
          whyChooseHeadline: 'whyChooseHeadline',
          whyChooseDescription: 'whyChooseDescription',
          testimonialHeadline: 'testimonialHeadline',
