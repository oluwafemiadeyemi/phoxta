...
<html lang="zxx">
    <head>
        ...
        <!--====== Favicon Icon ======-->
        <link rel="shortcut icon" href="assets/images/ai-agency/favicon.png" type="image/png">
        <!--====== Google Fonts ======-->
    ...
    <body <?php echo (isset($body_class) && ("" !== $body_class)) ? 'class="' . $body_class .'"'   : ''; ?>>
        ...
        <div class="preloader">
            <div class="loading-wrapper">
                ...
                <div id="loading-icon"><img src="assets/images/ai-agency/loader.png" alt=""></div>
            </div>
        </div>
        <!--====== Start Overlay ======-->
        <div class="offcanvas__overlay"></div>
        <!--======  Start Header Area  ======-->
        <header class="header-area header-five transparent-header">
            <div class="container">
                <!--====  Header Navigation  ===-->
                    ...
                    <div class="nav-inner-menu">
                        ...
                        <div class="primary-menu">
                            ...
                            <div class="site-branding">
                                <a href="index.php" class="brand-logo"><img src="assets/images/ai-agency/logo/logo-white.png" alt="Brand Logo"></a>
                            </div>
                            <!--=== Xeno Main Menu ===-->
                            <div class="xeno-nav-menu">
                                ...
                                <div class="xeno-menu-top d-flex justify-content-between d-block d-lg-none">
                                    <div class="site-branding">
                                        <a href="index.php" class="brand-logo"><img src="assets/images/ai-agency/logo/logo-main.png" alt="Brand Logo"></a>
                                    </div>
                                ...
                                <div class="xeno-nav-button mt-20 d-block d-md-none">
                                    <a href="contact.php" class="theme-btn style-one">Try for free<i class="far fa-angle-double-right"></i></a>
                                </div>
                                <!--=== Xeno Menu Bottom ===-->
                            ...
                            <div class="nav-right-item">
                                <div class="nav-button d-none d-md-block">
                                    <a href="contact.php" class="theme-btn style-one">Sign Up<i class="far fa-angle-double-right"></i></a>
                                </div>
