...
<html lang="zxx">
    <head>
        ...
        <!--====== Favicon Icon ======-->
        <link rel="shortcut icon" href="assets/images/website-agency/favicon.png" type="image/png">
        <!--====== Google Fonts ======-->
        ...
        <div class="preloader">
            <div class="loading-wrapper">
                ...
                <div id="loading-icon"><img src="assets/images/website-agency/loader.png" alt=""></div>
            </div>
        </div>
        <!--====== Start Overlay ======-->
                    ...
                    <div class="nav-inner-menu">
                        ...
                        <div class="primary-menu">
                            ...
                            <div class="site-branding">
                                <a href="index.php" class="brand-logo"><img src="assets/images/website-agency/logo/logo-main.png" alt="Brand Logo"></a>
                            </div>
                            <!--=== Xeno Main Menu ===-->
                            ...
                            <div class="nav-right-item">
                                <div class="nav-button d-none d-md-block">
                                    <a href="contact.php" class="theme-btn style-one">Let’s Talk<i class="far fa-angle-double-right"></i></a>
                                </div>
