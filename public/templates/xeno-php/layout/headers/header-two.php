...
<html lang="zxx">
    <head>
        ...
        <!--====== Favicon Icon ======-->
        <link rel="shortcut icon" href="assets/images/design-studio/favicon.png" type="image/png">
        <!--====== Google Fonts ======-->
    ...
    <body <?php echo (isset($body_class) && ("" !== $body_class)) ? 'class="' . $body_class .'"'   : ''; ?>>
        ...
        <div class="preloader">
            <div class="loading-wrapper">
                ...
                <div id="loading-icon"><img src="assets/images/design-studio/loader.png" alt=""></div>
            </div>
        </div>
        <!--====== Start Overlay ======-->
                    ...
                    <div class="nav-inner-menu">
                        ...
                        <div class="primary-menu">
                            ...
                            <div class="site-branding">
                                <a href="index.php" class="brand-logo"><img src="assets/images/design-studio/logo/logo-white.png" alt="Brand Logo"></a>
                            </div>
                            <!--=== Xeno Main Menu ===-->
