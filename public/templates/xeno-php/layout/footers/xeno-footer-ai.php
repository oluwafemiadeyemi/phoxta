                ...
                <!--====== Start Footer ======-->
                <footer class="xeno-footer-ai bg_cover" style="background-image: url(assets/images/ai-agency/bg/footer-bg.jpg);">
                    <div class="footer-shape"><img src="assets/images/ai-agency/bg/footer-shape1.png" alt="shape"></div>
                    <!-- Footer Widget Area -->
                    <div class="footer-widget-area pt-70 pb-60">
                        <div class="container">
                            <div class="row">
                                    ...
                                    <div class="footer-widget footer-about-widget mb-40" data-aos="fade-up" data-aos-duration="1000">
                                        <div class="footer-content">
                                            <div class="footer-logo">
                                                <img src="assets/images/ai-agency/logo/logo-white.png" alt="Logo">
                                            </div>
